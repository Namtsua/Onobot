       ...
       private async Task ProgramAsync(IGuildUser user, SocketGuild guild, string program)
        {
            ...
            switch(tag)
            {
                ...
                case 13: tagID = _keys["Masters"]; break;
                case 14: tagID = _keys["Music"]; break;
                case 15: tagID = _keys["Pharmacology"]; break;
                case 16: tagID = _keys["Pharmacy"]; break;
                case 17: tagID = _keys["PhD"]; break;
                case 18: tagID = _keys["Physics & Astronomy"]; break;
                case 19: tagID = _keys["Political Science"]; break;
                case 20: tagID = _keys["Sauder"]; break;
                case 21: tagID = _keys["Science"]; break;
                case 22: tagID = _keys["Statistics"]; break;
                case 23: tagID = _keys["VISA"]; break;
                case 24: tagID = _keys["Langara Student"]; break;
                case 25: tagID = _keys["UVIC/SFU Spy"]; break;
                case 26: tagID = _keys["High School Student"]; break;
                case 27: return;
                default: break;
            }   
       ...
       private Task Reply(string message)
         ...
         private string findProgramMessage(int program)
        {
            ...
            switch(program)
            {
                ...
                case 13: customMessage = _messages["Masters"]; break;
                case 14: customMessage = _messages["Music"]; break;
                case 15: customMessage = _messages["Pharmacology"]; break;
                case 16: customMessage = _messages["Pharmacy"]; break;
                case 17: customMessage = _messages["PhD"]; break;
                case 18: customMessage = _messages["Physics & Astronomy"]; break;
                case 19: customMessage = _messages["Political Science"]; break;
                case 20: customMessage = _messages["Sauder"]; break;
                case 21: customMessage = _messages["Science"]; break;
                case 22: customMessage = _messages["Statistics"]; break;
                case 23: customMessage = _messages["VISA"]; break;
                case 24: customMessage = _messages["Langara Student"]; break;
                case 25: customMessage = _messages["UVIC/SFU Spy"]; break;
                case 26: customMessage = _messages["High School Student"]; break;
                case 27: customMessage = _messages["No Program"]; break;
                default: break;
            }
